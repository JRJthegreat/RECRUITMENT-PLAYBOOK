...
Column layout (29 cols):
  ...
  Tech extras AB-AC: template_variant, cleaned_role
"""
...
def main():
    parser = argparse.ArgumentParser(description="Pull Apify Indeed tech dataset → Google Sheet")
    ...
    parser.add_argument("--sheet_title", default="Tech Indeed Leads", help="Title for new sheet (ignored if --sheet_url)")
    ...
    print("=== Pull Apify Tech Indeed Dataset → Google Sheet ===\n")
